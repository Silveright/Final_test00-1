...
<body>
	...
	<div class="container">
			...
			<div class="col-sm-9 ">
				...
				<form action="memberinfocat" method="post" class="cat">
					...
					<input type="button" class="btn btn-secondary" value="회원 정보"
						onclick="location.href='groupuserinfo'"> <input
						type="button" class="btn btn-secondary" value="가입 승인"
						onclick="location.href='groupjoinagree'"> <input
						type="button" class="btn btn-secondary" value="모임 해산"
				...
				<c:if test="${listcount > 0 }">
					<form action="memberinfo" method="post">
						<div class="input-group center-block">
							...
							</select> <input id="search" name="search_word" type="text"
								...
								<ul class="pagination justify-content-center">
									...
									<c:if test="${page >1 }">
										<li class="page-item"><a class="page-link"
											href="memberinfo?page=${page-1 }&search_field=${search_field}&search_word=${search_word}"
											aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
										</a></li>
									</c:if>
		...
		<c:if test="${listcount==0 }">
			<section class="py-5">
				<font size=5>회원이 존재하지 않습니다.</font><br>
				<br> <a href="main.net"><button type="button"
						class="btn btn-secondary float-left back">메인으로</button></a>
			</section>
		</c:if>
	</div>
